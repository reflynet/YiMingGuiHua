...
@property  YMContactEntity* entity;
...
@implementation YMContactDeleage
@synthesize result;
@synthesize entity;
...
-(void)getData :(void (^)(NSMutableArray *arr))compete
{
    ...
    NSString* requestUrl = [NSString stringWithFormat:@"%@client/?c=member&a=itemlist&pagesize=5&sortcolumn=department&sortmethod=asc",[YMCommon getServer]];
